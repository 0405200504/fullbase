...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-[13px] font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 transition-all rounded-none",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 rounded-none",
        outline:
          "border border-border bg-transparent hover:border-foreground hover:text-foreground rounded-none transition-all",
        secondary:
          "bg-secondary/50 text-foreground hover:bg-secondary transition-all rounded-none",
        ghost: "hover:bg-secondary/50 hover:text-foreground transition-all rounded-none",
